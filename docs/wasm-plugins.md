...
!!! note
	You can find an example of "Wasm Function Calling" in [examples/18-call-functions-for-real](https://github.com/mitjafelicijan/parakeet/tree/main/examples/18-call-functions-for-real) - the wasm plugin is located in the `wasm` folder and it is built with **[TinyGo](https://tinygo.org/)**.
